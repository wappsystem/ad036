...
var new_start=function(){
    $('.start-button').hide();
    ClearIntervals();
    $('#thirdparty_container__ID').css('background-color','#000000');
    Instructions();
    finished=false;
    results = {
        Time : [],
...
var Finish = function()
{
    ...
    if (!finished)
    {
        ...
        //console.log("finish: "+JSON.stringify(responce))
        data_process(responce);
    }
}
//-------------------------------------
